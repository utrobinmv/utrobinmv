...
| Обязанности                                      | * Подготовка датасета<br />* Генерация примеров аудио команд (TTS) <br />* Аугументация текстовых данных<br />* Подготовка данных, приведение чисел в строковый вид, расстановка ударений<br />* Обучение языковой модели<br />* Подбор гиперпараметров<br /> |
